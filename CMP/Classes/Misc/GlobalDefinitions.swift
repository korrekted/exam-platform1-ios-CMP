...
final class GlobalDefinitions {
    ...
    static let apiKey = "rQsRjXJ7slx1oiF9"

    static let sdkDomainUrl = "https://analytics.korrekted.com"
    static let sdkApiKey = "aDEeaoagnCCeq1Ic"

    static let applicationTag = "EXAM_CMP"

    static let amplitudeApiKey = "b503251969f4b1d7901d2f7d1388d476"
    static let appsFlyerApiKey = "DCciCfYXjMQ8QnkdCg8qzk"

    static let appStoreUrl = "https://apps.apple.com/app/cmp-exam/id1623173009"
    static let appleAppID = "1623173009"
